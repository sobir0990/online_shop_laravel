...
$totalCount = \Cart::session(\Illuminate\Support\Facades\Session::getId())->getTotalQuantity();
                ...
                <div class="col-lg-8 col-md-8 col-12">
                    <div class="account-curr-lang-wrap f-right">
                        <ul>
                            ...
                            <li><a href="#"><img alt="flag" src="assets/img/icon-img/en.jpg"> English <i
            ...
            <div class="row">
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-5">
                    <div class="logo pt-39">
                        <a href="/"><img alt="" src="{{asset('assets/img/logo/logo.png')}}"></a>
                    </div>
                </div>
